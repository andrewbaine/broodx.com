...
var NotPossible = /* @__PURE__ */Caml_exceptions.create("Playground.NotPossible");

var t = Math.PI / 12;

var halfPi = Math.PI / 2;

function sketch(up, down, p) {
  var polygon = function (points) {
    if (points.length > 2) {
      p.fill(Point.ccw(undefined, Belt_Array.getExn(points, 0), Belt_Array.getExn(points, 1), Belt_Array.getExn(points, 2)) ? down : up);
      p.beginShape();
  ...
  var triangle = function (p1, p2, p3) {
    p.fill(Point.ccw(undefined, p1, p2, p3) ? down : up);
